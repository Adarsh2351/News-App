...
class AssociatedPressFragment : Fragment(), NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_associated_press, container, false)
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=associated-press&sortBy=relevancy&pageSize=100&apiKey=315e0be9f9c44895931e50e939b5f59b"
