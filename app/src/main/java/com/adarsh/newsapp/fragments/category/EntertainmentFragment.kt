package com.adarsh.newsapp.fragments.category
...
class EntertainmentFragment : Fragment(), NewsItemClicked {
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&pageSize=100&apiKey=8e5bfc438c3c4f68a6f2534cc53eac50"
