...
class ESPNFragment : Fragment(), NewsItemClicked {
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=espn&sortBy=relevancy&pageSize=100&apiKey=8a7152afd4f34dcb8880c84cb65a7a85"
