...
class TheVergeFragment : Fragment(), NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_the_verge, container, false)
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=the-verge&sortBy=relevancy&pageSize=100&apiKey=440654873b95427b801cd6a91f25f6ad"
