...
class ABCFragment : Fragment(), NewsItemClicked {
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=abc-news&sortBy=relevancy&pageSize=100&apiKey=315e0be9f9c44895931e50e939b5f59b"
