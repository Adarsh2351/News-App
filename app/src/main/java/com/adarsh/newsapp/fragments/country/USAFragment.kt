...
class USAFragment : Fragment(), NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_usa, container, false)
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/top-headlines?country=us&pageSize=100&apiKey=6bd4aa0c38264f7b9ff034995a0c7329"
