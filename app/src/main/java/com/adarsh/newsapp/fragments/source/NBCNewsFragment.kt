...
class NBCNewsFragment : Fragment(), NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_nbc_news, container, false)
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=nbc-news&sortBy=relevancy&pageSize=100&apiKey=8a7152afd4f34dcb8880c84cb65a7a85"
