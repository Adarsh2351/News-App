...
class TimeFragment : Fragment(), NewsItemClicked {
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?sources=time&sortBy=relevancy&pageSize=100&apiKey=440654873b95427b801cd6a91f25f6ad"
