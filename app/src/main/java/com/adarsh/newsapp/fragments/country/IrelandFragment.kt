...
class IrelandFragment : Fragment(), NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ireland, container, false)
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?q=ireland&sortBy=relevancy&pageSize=100&apiKey=819f7d22402c45d091e036aa337b6232"
