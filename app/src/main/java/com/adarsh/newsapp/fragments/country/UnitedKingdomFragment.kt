...
class UnitedKingdomFragment : Fragment(), NewsItemClicked {
    ...
    private fun loadNews() {
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            val url =
                "https://newsapi.org/v2/everything?q=united-kingdom&sortBy=relevancy&pageSize=100&apiKey=6bd4aa0c38264f7b9ff034995a0c7329"
